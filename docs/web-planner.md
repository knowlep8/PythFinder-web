...
- [ ] **3.1 Hub-side convention (quick-start repo).** *Written and fixed once
  on the robot; still unticked because the run has not yet completed on the
  hub.* The downloaded file
